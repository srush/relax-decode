...
\subsubsection[{set\_\-up}]{\setlength{\rightskip}{0pt plus 5cm}void MRF::set\_\-up ({\bf graph::Graph} {\em graph}, \/  int {\em nodes}, \/  int {\em edges})\hspace{0.3cm}{\ttfamily  \mbox{[}virtual\mbox{]}}}}
