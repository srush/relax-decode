...
\subsubsection[{fvector}]{\setlength{\rightskip}{0pt plus 5cm}virtual const {\bf svector}$<$int, double$>$\& Scarab::HG::Hyperedge::fvector () const\hspace{0.3cm}{\ttfamily  \mbox{[}pure virtual\mbox{]}}}}
