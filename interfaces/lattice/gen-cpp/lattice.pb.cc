...
void protobuf_AssignDesc_lattice_2eproto() {
  ...
  static const int Phraselet_offsets_[3] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Phraselet, hypergraph_edge_position_),
  };
  ...
  static const int Origin_offsets_[4] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Origin, hypergraph_edge_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Origin, hypergraph_edge_position_),
...
void protobuf_AddDesc_lattice_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "pergraph_node_id\030\003 \001(\005\"t\n\tPhraselet\022\036\n\004w"
    "ord\030\001 \003(\0132\020.lattice.Subword\022!\n\031phraselet"
    "_hypergraph_edge\030\002 \001(\005\022$\n\030hypergraph_edg"
    "e_position\030\004 \001(\005:\002-1\"3\n\nPhraselets\022%\n\tph"
    "raselet\030\001 \003(\0132\022.lattice.Phraselet\"l\n\006Ori"
    "gin\022\027\n\017hypergraph_edge\030\001 \003(\005\022 \n\030hypergra"
    "ph_edge_position\030\004 \003(\005\022\023\n\013original_id\030\002 "
    "\001(\005\022\022\n\nhas_origin\030\003 \001(\010:>\n\nphraselets\022\025."
    "lattice.Lattice.Node\030d \001(\0132\023.lattice.Phr"
    "aselets:*\n\013has_phrases\022\025.lattice.Lattice"
    ".Node\030e \001(\010:6\n\006origin\022\025.lattice.Lattice."
    "Edge\030n \001(\0132\017.lattice.Origin:.\n\024num_hyper"
    "graph_edges\022\020.lattice.Lattice\030y \001(\005:*\n\020n"
    "um_original_ids\022\020.lattice.Lattice\030z \001(\005", 879);
...
const int Phraselet::kHypergraphEdgePositionFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(32)) goto parse_hypergraph_edge_position;
        break;
      }
      ...
      case 4: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_hypergraph_edge_position:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 input, &hypergraph_edge_position_)));
...
void Phraselet::SerializeWithCachedSizes(
  ...
  // optional int32 hypergraph_edge_position = 4 [default = -1];
  if (has_hypergraph_edge_position()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(4, this->hypergraph_edge_position(), output);
  }
...
::google::protobuf::uint8* Phraselet::SerializeWithCachedSizesToArray(
  ...
  // optional int32 hypergraph_edge_position = 4 [default = -1];
  if (has_hypergraph_edge_position()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(4, this->hypergraph_edge_position(), target);
  }
...
void Phraselet::MergeFrom(const Phraselet& from) {
  ...
  if (from._has_bits_[1 / 32] & (0xffu << (1 % 32))) {
    ...
    if (from.has_hypergraph_edge_position()) {
      set_hypergraph_edge_position(from.hypergraph_edge_position());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
void Phraselet::Swap(Phraselet* other) {
  if (other != this) {
    ...
    std::swap(hypergraph_edge_position_, other->hypergraph_edge_position_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
...
const int Origin::kHypergraphEdgePositionFieldNumber;
      ...
      case 4: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_hypergraph_edge_position:
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitive<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 1, 32, input, this->mutable_hypergraph_edge_position())));
        } else if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag)
                   == ::google::protobuf::internal::WireFormatLite::
                      WIRETYPE_LENGTH_DELIMITED) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadPackedPrimitiveNoInline<
                   ::google::protobuf::int32, ::google::protobuf::internal::WireFormatLite::TYPE_INT32>(
                 input, this->mutable_hypergraph_edge_position())));
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectTag(32)) goto parse_hypergraph_edge_position;
...
void Origin::SerializeWithCachedSizes(
  ...
  // repeated int32 hypergraph_edge_position = 4;
  for (int i = 0; i < this->hypergraph_edge_position_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(
      4, this->hypergraph_edge_position(i), output);
  }
...
::google::protobuf::uint8* Origin::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->hypergraph_edge_position_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteInt32ToArray(4, this->hypergraph_edge_position(i), target);
  }
...
int Origin::ByteSize() const {
  ...
  // repeated int32 hypergraph_edge_position = 4;
  {
    ...
    for (int i = 0; i < this->hypergraph_edge_position_size(); i++) {
      data_size += ::google::protobuf::internal::WireFormatLite::
        Int32Size(this->hypergraph_edge_position(i));
    }
    total_size += 1 * this->hypergraph_edge_position_size() + data_size;
  }
...
void Origin::MergeFrom(const Origin& from) {
  ...
  hypergraph_edge_position_.MergeFrom(from.hypergraph_edge_position_);
...
void Origin::Swap(Origin* other) {
  if (other != this) {
    ...
    hypergraph_edge_position_.Swap(&other->hypergraph_edge_position_);
