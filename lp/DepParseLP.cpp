...
void DepParserLPBuilder::show_results(const DepParserLP & lp_vars) {
...
DepParserLP * DepParserLPBuilder::add_parse(const DepParser & parser, const Cache<Hyperedge, double> & weights,
