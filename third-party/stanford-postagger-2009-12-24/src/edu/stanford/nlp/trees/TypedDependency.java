...
public class TypedDependency implements Comparable<TypedDependency>, Serializable {
  ...
  public String toString() {
    if (dep.label.get(CopyAnnotation.class) != null && dep.label.get(CopyAnnotation.class) != null) {
      return reln + "(" + gov + ", " + dep + "')";
    } else if (gov.label.get(CopyAnnotation.class) != null && gov.label.get(CopyAnnotation.class) !=null) {
      return reln + "(" + gov + "', " + dep + ')';
    } else {
      return reln + "(" + gov + ", " + dep + ')';
    }
