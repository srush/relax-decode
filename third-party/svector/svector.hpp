...
template <class F, class V>
svector<F,V> operator* (const svector<F,V>& x, const V& y) {  svector<F,V> z(x); z *= y; return z; }

template <class F, class V>
svector<F,V> operator* (const V& x, const svector<F,V>& y) { svector<F,V> z(y); z *= x; return z; }

template <class F, class V>
svector<F,V> operator/ (const svector<F,V>& x, const V& y) { svector<F,V> z(x); z /= y; return z; }

template <class F, class V>
svector<F,V> operator+ (const svector<F,V>& x, const svector<F,V>& y) {  svector<F,V> z(x); z += y; return z; }
